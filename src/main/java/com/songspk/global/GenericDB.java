...
import com.songspk.database.DatabaseConnection;
import com.songspk.database.DatabaseConnectionPool;
import com.songspk.database.DatabaseUtil;
...
public class GenericDB<T> {
    ...
    public T getMinFromTable(Field<?> x, TableLike<?> table, Condition condition) {
        ...
        try {
            ...
            DatabaseConnection.leaveConnection(conn);
        }
        return null;
    }
    ...
    public boolean updateColumn(Field<T> x, T t, org.jooq.impl.TableImpl<?> table, Condition condition) {
        Connection conn = null;
        try {
            conn =databaseConnectionPool.getConnection();
    ...
    public static void main(String[] args) {
        Album album = new Album("Padmavati","htpp://lin123",
                true,"2014","Bhansali",
                "Bhansali",null);
        new GenericDB().addRow(com.songspk.tables.Albums.ALBUMS,album);
